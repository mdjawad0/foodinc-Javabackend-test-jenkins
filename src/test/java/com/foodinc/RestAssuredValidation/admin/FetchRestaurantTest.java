...
public class FetchRestaurantTest {
	...
	public void testFetchRestaurants() {
        ...
        // Check if database has more than 10 restaurants
	...
	@Test
	public void validateFetchRestaurantWithRestAssured() {
		...
		given()
                ...
                .body(
                		...
                		"data[0].restaurantId", equalTo(22)
                );
